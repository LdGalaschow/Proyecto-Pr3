...
public:
    ...
    void setupUi(QMainWindow *ventanapredictor)
    {
        ...
        actionBuscar = new QAction(ventanapredictor);
        ...
        menuHerramientas->addAction(actionBuscar);
    ...
    void retranslateUi(QMainWindow *ventanapredictor)
    {
        ...
        actionBuscar->setText(QApplication::translate("ventanapredictor", "Buscar", 0));
        ...
        menuHerramientas->setTitle(QApplication::translate("ventanapredictor", "Herramientas", 0));
    } // retranslateUi
