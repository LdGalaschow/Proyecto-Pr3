...
#include "../textpredictor/creditos.h"
...
const QMetaObject creditos::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_creditos.data,
      qt_meta_data_creditos,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *creditos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_creditos.stringdata0))
        return static_cast<void*>(const_cast< creditos*>(this));
